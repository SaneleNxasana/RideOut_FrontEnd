 ...
 */
public class CoupeRepositoryImpl extends SQLiteOpenHelper implements CoupeRepository {
    ...
    public CoupeRepositoryImpl(Context context){
    ...
    @Override
    public Coupe create(Coupe entity) {
        open();
        ...
        Coupe insertEntity = new Coupe.Builder()
                .copy(entity)
    ...
    public Coupe readById(Long id) {
        ...
        if (cursor.moveToFirst()){
            final Coupe Coupe = new Coupe.Builder()
    ...
    @Override
    public Set<Coupe> readAll() {
        SQLiteDatabase db = this.getReadableDatabase();
        Set<Coupe> Coupe = new HashSet<>();
        open();
        Cursor cursor = db.query(TABLE_NAME, null,null,null,null,null,null);
        if (cursor.moveToFirst()) {
            do {
                final Coupe setting = new Coupe.Builder()
                        .idNumber(cursor.getLong(cursor.getColumnIndex(COLUMN_ID)))
                        .registrationNumber(cursor.getString(cursor.getColumnIndex(COLUMN_REGISTRATIONNUMBER)))
                        .numberSeats(cursor.getString(cursor.getColumnIndex(COLUMN_NUMBERSEATS)))
                        .build();
    ...
    @Override
    public Coupe update(Coupe entity) {
        open();
        ContentValues values = new ContentValues();
        values.put(COLUMN_ID, entity.getIdNumber());
        values.put(COLUMN_REGISTRATIONNUMBER, entity.getRegistrationNumber());
    ...
    @Override
    public Coupe delete(Coupe entity) {
        open();
        db.delete(
                TABLE_NAME,
                COLUMN_ID + " =? ",
